...
| Set up new report notification | **Small** | **To Do** | Owner action: configure Supabase database webhook on `bug_reports` insert in the Supabase dashboard. Not code, so cannot be done by AI. |
