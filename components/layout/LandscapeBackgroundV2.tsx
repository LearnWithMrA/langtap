...
function DistantTree({ cx, cy, scale = 1 }: { cx: number; cy: number; scale?: number }) {
  return (
    <g transform={`translate(${cx}, ${cy}) scale(${scale})`} style={{ fill: 'var(--scene-hill)' }}>
      <rect x="-1" y="0" width="2" height="12" style={{ filter: 'brightness(0.35)' }} />
      <circle cx="0" cy="-6" r="10" style={{ filter: 'brightness(0.8)' }} />
      <circle cx="-5" cy="-2" r="7" style={{ filter: 'brightness(0.9)' }} />
      <circle cx="5" cy="0" r="6" style={{ filter: 'brightness(0.7)' }} />
    </g>
  )
}
...
function Tree({ cx, cy, scale = 1 }: { cx: number; cy: number; scale?: number }) {
  return (
    <g transform={`translate(${cx}, ${cy}) scale(${scale})`} style={{ fill: 'var(--scene-hill)' }}>
      <path d="M -1.5 0 L 1.5 0 L 1 15 L -1 15 Z" style={{ filter: 'brightness(0.3)' }} />
      <circle cx="0" cy="-12" r="16" style={{ filter: 'brightness(1.05)' }} />
      <circle cx="-10" cy="-4" r="12" style={{ filter: 'brightness(1.15)' }} />
      <circle cx="10" cy="-6" r="10" style={{ filter: 'brightness(0.95)' }} />
    </g>
  )
}
...
function BigGrass({ x, y }: { x: number; y: number }) {
  return (
    <g transform={`translate(${x}, ${y})`} style={{ fill: 'var(--scene-ground)' }}>
      <path d="M 0 0 Q 15 -35 30 0 Q 15 -10 0 0 Z" style={{ filter: 'brightness(0.95)' }} />
      <path d="M 20 5 Q 35 -20 50 5 Q 35 -5 20 5 Z" style={{ filter: 'brightness(0.85)' }} />
      <path d="M -15 2 Q -5 -25 5 2 Q -5 -5 -15 2 Z" style={{ filter: 'brightness(0.9)' }} />
    </g>
  )
}
...
function Furthest1(): ReactNode {
  return (
    <svg width="100%" height="100%" viewBox="0 0 1600 400" preserveAspectRatio="none" shapeRendering="crispEdges" xmlns="http://www.w3.org/2000/svg" className="absolute -bottom-px w-full h-[102%]">
  ...
  return (
    <svg width="100%" height="100%" viewBox="0 0 1600 400" preserveAspectRatio="none" shapeRendering="crispEdges" xmlns="http://www.w3.org/2000/svg" className="absolute -bottom-px w-full h-[102%]">
      ...
      */}
      ...
      <g style={{ fill: 'var(--scene-ground)' }}>
        <ellipse cx="120" cy="110" rx="10" ry="3.5" style={{ filter: 'sepia(0.5) hue-rotate(-10deg) brightness(1.3)' }} />
        <ellipse cx="180" cy="160" rx="5" ry="2" style={{ filter: 'sepia(0.5) hue-rotate(-10deg) brightness(0.6)' }} />
        <ellipse cx="450" cy="140" rx="8" ry="3" style={{ filter: 'sepia(0.5) hue-rotate(-10deg) brightness(1.2)' }} />
        <ellipse cx="550" cy="200" rx="14" ry="5" style={{ filter: 'sepia(0.5) hue-rotate(-10deg) brightness(0.8)' }} />
        <ellipse cx="850" cy="130" rx="12" ry="4" style={{ filter: 'sepia(0.5) hue-rotate(-10deg) brightness(0.7)' }} />
        <ellipse cx="1050" cy="150" rx="7" ry="2" style={{ filter: 'sepia(0.5) hue-rotate(-10deg) brightness(1.3)' }} />
        <ellipse cx="1300" cy="140" rx="9" ry="3" style={{ filter: 'sepia(0.5) hue-rotate(-10deg) brightness(1.4)' }} />
        <ellipse cx="1380" cy="190" rx="6" ry="2.5" style={{ filter: 'sepia(0.5) hue-rotate(-10deg) brightness(0.6)' }} />
      </g>
        ...
        {/* Shrub detail layer */}
        <svg x="-10" y="-140" width="1620" height="498" viewBox="0 0 4434 1193" preserveAspectRatio="none">
...
export function LandscapeBackgroundV2({ speed = 'idle', staticHills = false }: LandscapeBackgroundProps): ReactNode {
    ...
    <div className="absolute inset-0 overflow-visible" style={{ backgroundColor: 'var(--scene-sky-bottom)' }}>
      ...
      <div className="absolute bottom-[27%] left-0 right-0 h-[40%]">
        {staticHills ? (
          ...
          <motion.div className="absolute inset-0 flex" animate={{ x: ['0%', '-50%'] }} transition={{ duration: farHillDuration, repeat: Infinity, ease: 'linear' }} style={{ width: '200%' }}>
            <div className="w-1/2 h-full relative" style={{ backfaceVisibility: 'hidden', willChange: 'transform' }}><Furthest1 /></div>
            <div className="w-1/2 h-full relative" style={{ backfaceVisibility: 'hidden', willChange: 'transform' }}><Furthest1 /></div>
            <div className="absolute left-[50%] top-[35%] w-1 h-[65%] -ml-px" style={{ backgroundColor: 'var(--scene-hill-far-pale)' }} />
          </motion.div>
        )}
      </div>
      ...
      <div className="absolute bottom-[27%] left-0 right-0 h-[40%]">
        {staticHills ? (
          ...
          <motion.div className="absolute inset-0 flex" animate={{ x: ['0%', '-50%'] }} transition={{ duration: farHillDuration * 0.9, repeat: Infinity, ease: 'linear' }} style={{ width: '200%' }}>
            <div className="w-1/2 h-full relative" style={{ backfaceVisibility: 'hidden', willChange: 'transform' }}><Furthest2 /></div>
            <div className="w-1/2 h-full relative" style={{ backfaceVisibility: 'hidden', willChange: 'transform' }}><Furthest2 /></div>
            <div className="absolute left-[50%] top-[45%] w-1 h-[55%] -ml-px" style={{ backgroundColor: 'var(--scene-hill-far)' }} />
          </motion.div>
        )}
      </div>
      ...
      <div className="absolute bottom-[20%] left-0 right-0 h-[35%]">
        {staticHills ? (
          ...
          <motion.div className="absolute inset-0 flex" animate={{ x: ['0%', '-50%'] }} transition={{ duration: midBackDuration, repeat: Infinity, ease: 'linear' }} style={{ width: '200%' }}>
            <div className="w-1/2 h-full relative" style={{ backfaceVisibility: 'hidden', willChange: 'transform' }}><Furthest3 /></div>
            <div className="w-1/2 h-full relative" style={{ backfaceVisibility: 'hidden', willChange: 'transform' }}><Furthest3 /></div>
            <div className="absolute left-[50%] top-[55%] w-1 h-[45%] -ml-px" style={{ backgroundColor: 'var(--scene-hill-mid)' }} />
          </motion.div>
        )}
      </div>
      ...
      <div className="absolute bottom-[14%] left-0 right-0 h-[30%]">
        {staticHills ? (
          ...
          <motion.div className="absolute inset-0 flex" animate={{ x: ['0%', '-50%'] }} transition={{ duration: midFrontDuration, repeat: Infinity, ease: 'linear' }} style={{ width: '200%' }}>
            <div className="w-1/2 h-full relative" style={{ backfaceVisibility: 'hidden', willChange: 'transform' }}><Furthest4 /></div>
            <div className="w-1/2 h-full relative" style={{ backfaceVisibility: 'hidden', willChange: 'transform' }}><Furthest4 /></div>
            <div className="absolute left-[50%] top-[65%] w-1 h-[35%] -ml-px" style={{ backgroundColor: 'var(--scene-hill-front)' }} />
          </motion.div>
        )}
      </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-[25%]" style={{ backgroundColor: 'var(--scene-ground)' }}>
        <motion.div className="absolute inset-0 flex" animate={{ x: ['0%', '-50%'] }} transition={{ duration: groundDuration, repeat: Infinity, ease: 'linear' }} style={{ width: '200%' }}>
          <div className="w-1/2 h-full relative" style={{ backfaceVisibility: 'hidden', willChange: 'transform' }}><Closest5 /></div>
          <div className="w-1/2 h-full relative" style={{ backfaceVisibility: 'hidden', willChange: 'transform' }}><Closest5 /></div>
          {/* Seam cover: dirt path zone */}
          <div className="absolute left-[50%] top-[17%] w-1 h-[43%] -ml-px" style={{ backgroundColor: 'var(--scene-ground)', filter: 'sepia(0.6) hue-rotate(-25deg) saturate(0.9) brightness(0.85)' }} />
          {/* Seam cover: dark grass zone */}
          <div className="absolute left-[50%] top-[60%] w-1 h-[40%] -ml-px" style={{ backgroundColor: 'var(--scene-ground)', filter: 'brightness(0.85)' }} />
        </motion.div>
      </div>
