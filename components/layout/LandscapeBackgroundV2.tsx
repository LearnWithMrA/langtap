...
function _BigGrass({ x, y }: { x: number; y: number }): ReactNode {
  return (
  ...
  return (
    ...
    >
      ...
      <path
        ...
        style={{ fill: 'var(--scene-ground)', filter: 'brightness(1.05)' }}
      />
      ...
      <path
        ...
        style={{
          ...
          filter: 'sepia(0.6) hue-rotate(-25deg) saturate(0.9) brightness(0.85)',
        }}
      />
      ...
      <g style={{ fill: 'var(--scene-ground)' }}>
        <ellipse
          ...
          rx="10"
          ry="3.5"
          style={{ filter: 'sepia(0.5) hue-rotate(-10deg) brightness(1.3)' }}
        />
        <ellipse
          cx="180"
          cy="160"
          rx="5"
          ry="2"
          style={{ filter: 'sepia(0.5) hue-rotate(-10deg) brightness(0.6)' }}
        />
        <ellipse
          cx="450"
          cy="140"
          rx="8"
          ry="3"
          style={{ filter: 'sepia(0.5) hue-rotate(-10deg) brightness(1.2)' }}
        />
        <ellipse
          cx="550"
          cy="200"
          rx="14"
          ry="5"
          style={{ filter: 'sepia(0.5) hue-rotate(-10deg) brightness(0.8)' }}
        />
        <ellipse
          cx="850"
          cy="130"
          rx="12"
          ry="4"
          style={{ filter: 'sepia(0.5) hue-rotate(-10deg) brightness(0.7)' }}
        />
        <ellipse
          cx="1050"
          cy="150"
        ...
        <ellipse
          ...
          rx="9"
          ry="3"
          style={{ filter: 'sepia(0.5) hue-rotate(-10deg) brightness(1.4)' }}
        />
        <ellipse
          cx="1380"
          cy="190"
    ...
    >
      ...
      >
        <path
          ...
          style={{ fill: 'var(--scene-ground)', filter: 'brightness(0.6) saturate(1.2)' }}
        />
      </svg>
      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              backgroundColor: 'var(--scene-ground)',
              filter: 'sepia(0.6) hue-rotate(-25deg) saturate(0.9) brightness(0.85)',
            }}
          />
        </motion.div>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-[25%] z-[4] pointer-events-none">
        ...
        >
          ...
          <div
            ...
            style={{ backgroundColor: 'var(--scene-ground)', filter: 'brightness(0.85)' }}
          />
        </motion.div>
      </div>
