// ─────────────────────────────────────────────
// File: samples/kotoba-dojo-words.ts
// Purpose: Mock word data for the Kotoba Dojo visual shell.
//          Organised by JLPT level (N5-N1), three units per level,
//          two groups of twelve words per unit.
